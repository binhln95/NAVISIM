...
DeviceInfo LMS64CProtocol::GetDeviceInfo(void)
{
    ...
    devInfo.firmwareVersion = itoa(int(lmsInfo.firmware));
    devInfo.hardwareVersion = itoa(int(lmsInfo.hardware));
    devInfo.protocolVersion = itoa(int(lmsInfo.protocol));
    ...
    devInfo.gatewareVersion = itoa(int(gatewareInfo.gatewareVersion));
    devInfo.gatewareRevision = itoa(int(gatewareInfo.gatewareRevision));
